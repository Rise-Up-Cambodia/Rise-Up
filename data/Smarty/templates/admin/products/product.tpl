...
<div id="products" class="contents-main">
    ...
    <table class="form">
        ...
        <tr>
            <th><!--{t string="tpl_Product category<spanf class='attention'> *</span>_01" escape="none"}--></th>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn-normal" href="javascript:;" name="btn" onclick="selectAll('category_id'); fnModeSubmit('upload', 'image_key', '<!--{$key}-->'); return false;"><!--{t string="tpl_Upload_01"}--></a>
            </td>
        </tr>
        <tr>
