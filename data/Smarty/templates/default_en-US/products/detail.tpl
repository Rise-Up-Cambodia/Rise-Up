                    ...
                    <div class="classlist">
                        ...
                        <ul class="clearfix">
                            ...
                            <li>
                                ...
                                <br /><span class="attention">* Input <!--{$tpl_class_name1}-->.</span>
                                <!--{/if}-->
                            </li>
                        </ul>
                        <!--▲規格1-->
                        ...
                        <ul class="clearfix">
                            ...
                            <li>
                                ...
                                <br /><span class="attention">* Input <!--{$tpl_class_name2}-->.</span>
                                <!--{/if}-->
                            </li>
                        </ul>
                        <!--▲規格2-->
            ...
            <ul>
                <!--{section name=cnt loop=$arrReview}-->
                    <li>
                        ...
                        <p class="voicedate"><!--{$arrReview[cnt].create_date|sfDispDBDate:false}--> Posted by:<!--{if $arrReview[cnt].reviewer_url}--><a href="<!--{$arrReview[cnt].reviewer_url}-->" target="_blank"><!--{$arrReview[cnt].reviewer_name|h}--></a><!--{else}--><!--{$arrReview[cnt].reviewer_name|h}--><!--{/if}--> Recommendation level:<span class="recommend_level"><!--{assign var=level value=$arrReview[cnt].recommend_level}--><!--{$arrRECOMMEND[$level]|h}--></span></p>
