<?php /* Smarty version 2.6.26, created on 2015-06-17 04:31:23
         compiled from C:%5Cwamp%5Cwww%5CGift%5Chtml/../data/Smarty/templates/admin/ownersstore/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'C:\\wamp\\www\\Gift\\html/../data/Smarty/templates/admin/ownersstore/subnavi.tpl', 26, false),array('function', 't', 'C:\\wamp\\www\\Gift\\html/../data/Smarty/templates/admin/ownersstore/subnavi.tpl', 27, false),)), $this); ?>
...
ownersstore/log.php"><span><?php echo smarty_function_t(array('string' => 'tpl_Log management_01'), $this);?>
    ...
    <li id="navi-ownersstore-log" class="<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_subno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'admin'): ?>on<?php endif; ?>">
        <a href="<?php echo ((is_array($_tmp=@ROOT_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=@ADMIN_DIR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
ownersstore/admin.php"><span><?php echo smarty_function_t(array('string' => 'Brand Managenment'), $this);?>
</span></a></li>
</ul>