<?php /* Smarty version 2.6.26, created on 2015-06-12 08:08:08
         compiled from basis/seo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'basis/seo.tpl', 25, false),array('modifier', 'script_escape', 'basis/seo.tpl', 26, false),array('modifier', 'h', 'basis/seo.tpl', 45, false),)), $this); ?>

<form name="form1" id="form1" method="post" action="?" onSubmit="return window.confirm(<?php echo smarty_function_t(array('string' => "tpl_'Save changes?'_01"), $this);?>
);">
...
">
                        <table>
                            <tr>
                                <th><?php echo smarty_function_t(array('string' => "tpl_Meta tag: Author_01"), $this);?>
</th>
                                <td>
...
;<?php endif; ?>' /><span class="attention"> <?php echo smarty_function_t(array('string' => "tpl_(T_ARG1 characters max)_01",'T_ARG1' => ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</span></td>
                            </tr>
                            <tr>
                                <th><?php echo smarty_function_t(array('string' => "tpl_Meta tag: Description_01"), $this);?>
</th>
                                <td>
...
;<?php endif; ?>' /><span class="attention"> <?php echo smarty_function_t(array('string' => "tpl_(T_ARG1 characters max)_01",'T_ARG1' => ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
                            ...
                            <tr>
                                <th><?php echo smarty_function_t(array('string' => "tpl_Meta tag: Keywords_01"), $this);?>
</th>
                                <td>
...
; fnFormModeSubmit('form1', 'confirm', '', ''); return false;"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Save and continue_01'), $this);?>
</span></a></li>
                            </ul>
                        </div>
 ...
 ここまで -->
    ...
    <?php else: ?>
        <div class="no-data">
            <?php echo smarty_function_t(array('string' => 'tpl_There is no data to be displayed_01'), $this);?>
