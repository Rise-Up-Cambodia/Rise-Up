<?php /* Smarty version 2.6.26, created on 2015-06-28 04:52:09
         compiled from C:%5Cwamp%5Cwww%5CRise-Up-Shop%5Chtml/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 25, false),array('modifier', 'h', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 29, false),array('modifier', 'number_format', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 35, false),array('modifier', 'default', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 35, false),array('modifier', 'sfGetChecked', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 50, false),array('modifier', 'sfTrimURL', 'C:\\wamp\\www\\Rise-Up-Shop\\html/../data/Smarty/templates/default_en-US/frontparts/bloc/login.tpl', 58, false),)), $this); ?>
...
img/title/locker.png" /><span class="title">Login</span></h2>
                ...
                <?php else: ?>
                    <dl class="formlist">
                       <!-- {*<dt>E-mail address</dt>*}-->
                        <dd>
                            <input type="text" name="login_email" placeholder="Email" class="box140" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_login_email'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
','forget','600','400'); return false;" target="_blank">Retrieve lost password here</a>
					...
					<p><a href="http://localhost:8585/Rise-Up-Shop/html/entry/kiyaku.php">Register Now</a></p>
                    <p class="btn">
